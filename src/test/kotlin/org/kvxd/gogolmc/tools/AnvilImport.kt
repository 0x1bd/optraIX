package org.kvxd.gogolmc.tools
...
import org.kvxd.gogolmc.nbt.list
import org.kvxd.gogolmc.nbt.string
...
object AnvilImport {
    ...
    private fun importChunk(
        ...
        for (raw in root.list("block_entities") ?: NbtList(emptyList<NbtCompound>())) {
            ...
            if (y < 0 || y >= WORLD_HEIGHT) continue
            val loaded = org.kvxd.gogolmc.world.BlockEntityNbt.fromNbt(id.removePrefix("minecraft:"), entity)
                ?: continue
