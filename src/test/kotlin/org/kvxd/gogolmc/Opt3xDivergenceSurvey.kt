...
class Opt3xDivergenceSurvey {
    ...
    private fun firstDivergence(seed: Long, rows: Int, length: Int, ticks: Int): Int {
        ...
        val circuit = Opt3xCompiler.compile(candidateWorld, eliminateWire = false)
        circuit.settle()
    ...
    fun survey() {
        ...
        println("opt3x divergence survey over $total random circuits, $ticks ticks each")
