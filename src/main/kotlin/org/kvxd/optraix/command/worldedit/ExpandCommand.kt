...
class ExpandCommand(private val worldEdit: WorldEdit) : ServerCommand {

    override val name = "/expand"

    override val description = "grow the selection"
    ...
    private fun run(source: CommandSource, amount: Int, direction: String?) {
        SelectionResize.apply(source, worldEdit, amount, direction, grow = true)
    }
}
