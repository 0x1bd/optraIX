...
import org.kvxd.gogolmc.world.BlockEntities
import org.kvxd.gogolmc.world.BlockEntity
import org.kvxd.gogolmc.world.BlockPos
import org.kvxd.gogolmc.world.ContainerKind
...
object ContainerScreens {
    ...
    fun applyClick(world: GameWorld, player: Player, slot: Int, item: Slot) {
        ...
        if (item.present && itemId != null) {
            entries += org.kvxd.gogolmc.world.InventoryEntry(
                id = itemId,
                slot = slot,
    ...
    private fun rebuild(
        kind: ContainerKind,
        entries: List<org.kvxd.gogolmc.world.InventoryEntry>,
